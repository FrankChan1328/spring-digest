package sourcecode.applicationevent.casessimplespring.simplespring;
...
public class BravoApplicationContext {
    ...
    public void register() {
        // 假装扫描指定路径下的Bean
        beanDefinitionNames.add("sourcecode.applicationevent.casessimplespring.service.SmsService");
        beanDefinitionNames.add("sourcecode.applicationevent.casessimplespring.service.OrderService");
        beanDefinitionNames.add("sourcecode.applicationevent.casessimplespring.service.CarService");
    }
     ...
     * 详情请参考：
     * {@link sourcecode.applicationevent.casessimplespring.simplespring.bravo.event.BravoSimpleApplicationEventMuiltcaster#multicastEvent(BravoApplicationEvent)}
     */
